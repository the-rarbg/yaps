...
const Tv = () => {
    ...
    useEffect(() => {
            setimages(data !== undefined ? data.detail.seasons[0].poster_path : "")
    ...
    return (
        <>
            ...
            <div className={"grid lg:grid-rows-1 lg:grid-cols-2 grid-rows-2 grid-cols-1"}>
                <div
                ...
                <div className={` w-full flex flex-col float-right   ${lightStatus ? '' : 'h-full'} z-[999] h-full`}>
                    <div className={"float-end"}>
                        {
                            season.map((season, index) => {
                                return (
                                    <div>
                                        <iframe
                                            src={`https://vidsrc.to/embed/tv/${tmdb ? tmdb : id}/${tvDetails.season}/${tvDetails.episode}`}
                                            allowFullScreen="allowfullscreen"></iframe>
                                    </div>
                                )
                            })
